...
func SimulationOperations(app Delta, cdc codec.JSONCodec, config simtypes.Config) []simtypes.WeightedOperation {
...
func CheckExportSimulation(
	app Delta, config simtypes.Config, params simtypes.Params,
) error {
