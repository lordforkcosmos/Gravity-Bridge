...
func TestQueryValsetConfirm(t *testing.T) {
	...
	specs := map[string]struct {
		...
		"all good": {
			...
			// expResp:  []byte(`{"type":"polygonbridge/MsgValsetConfirm", "value":{"eth_address":"0x3232323232323232323232323232323232323232", "nonce": "1", "orchestrator": "cosmos1ees2tqhhhm9ahlhceh2zdguww9lqn2ckukn86l",  "signature": "alksdjhflkasjdfoiasjdfiasjdfoiasdj"}}`),
			expResp: types.QueryValsetConfirmResponse{
